<script lang="ts">
  ...
  import { CONFIG_SCHEMA, type Field } from '../lib/configMeta'
  ...
  let activeSection = CONFIG_SCHEMA[0].id
  let values: IniData = {}
  ...
  $: activeSchema = CONFIG_SCHEMA.find(s => s.id === activeSection)!
